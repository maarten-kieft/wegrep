  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center gap-8 px-4">
        ...
        <a
          href="/leagues"
          className="mt-8 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-xl px-12 py-6 rounded-lg shadow-2xl transition-all hover:scale-105 active:scale-95"
        >
          Start
        </a>
      </div>
